...
// Paleta do design system "Legacy Artisanal System"
...
final efraimTheme = ThemeData(
  ...
  // Cinzel para títulos, Montserrat para corpo
  textTheme: TextTheme(
    displayLarge: GoogleFonts.cinzel(fontSize: 48, fontWeight: FontWeight.w700, letterSpacing: 0.02 * 48),
    ...
    headlineSmall: GoogleFonts.cinzel(fontSize: 28, fontWeight: FontWeight.w600),
    bodyLarge: GoogleFonts.montserrat(fontSize: 18, fontWeight: FontWeight.w400, height: 1.6),
    bodyMedium: GoogleFonts.montserrat(fontSize: 16, fontWeight: FontWeight.w400, height: 1.5),
    labelLarge: GoogleFonts.montserrat(fontSize: 14, fontWeight: FontWeight.w600, letterSpacing: 0.1 * 14),
    labelSmall: GoogleFonts.montserrat(fontSize: 12, fontWeight: FontWeight.w500),
  ),
  // Bordas com raio 4px (padrão do design system)
  cardTheme: const CardThemeData(
    color: _surfaceContainerLowest,
    surfaceTintColor: Colors.transparent,
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.all(Radius.circular(4)),
      side: BorderSide(color: Color(0x1A173426)), // primary 10% opacity
    ),
  ),
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    border: OutlineInputBorder(
      ...
      borderSide: BorderSide(color: _onSurface.withValues(alpha: 0.2)),
    ),
  ...
  appBarTheme: AppBarTheme(
    ...
    elevation: 0,
    titleTextStyle: GoogleFonts.cinzel(fontSize: 24, fontWeight: FontWeight.w500, color: _primary),
